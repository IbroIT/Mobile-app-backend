"""
Django production settings for PythonAnywhere deployment.
"""
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'change-me-to-a-very-long-random-string-in-production')
...
# Gemini AI Settings
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY', 'AIzaSyBbKl5jJnNep4HEz2HjuaMbwFVS8avc078')
